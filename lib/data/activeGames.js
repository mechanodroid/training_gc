...
=======
>>>>>>> bd1e664c2c0e9185e7da66ea9ccdfa3d15bc1010
    var masterGame = _.find(masterGames, function(game){
      return (game.id == masterGameId);
    });

    if (!masterGame) throw new Error(errorMessages.invalid_game_id);
    ...
    ActiveGames.super.prototype.add.call(this, clonedGame);
